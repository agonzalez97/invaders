...
public class Assets extends AssetManager {
    ...
    public Animation<TextureRegion> space, alien, aliendie, naveidle, navedie, naveleft, naveright, naveshoot, shoot ,alienshoot;
    ...
    void loadAnimations(){
        ...
        navedie = new Animation<TextureRegion>(0.1f, atlas.findRegions("navedie"));
